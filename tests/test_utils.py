...
from src.utils import (fetch_and_show_currency_rates, get_card_number_list,
                       get_cashback_sum, get_greeting, get_operations_sum,
                       show_cards, show_top_5_transactions)
...
def test_fetch_and_show_currency_rates(mock_get):
    mock_get.return_value.json.return_value = (
        {'Date': '2024-07-20T11:30:00+03:00', 'PreviousDate': '2024-07-19T11:30:00+03:00',
         ...
         'Valute': {
             'AUD': {'ID': 'R01010', 'NumCode': '036', 'CharCode': 'AUD', 'Nominal': 1,
                     'Name': 'Австралийский доллар', 'Value': 58.9826, 'Previous': 59.2192},
             ...
             'HUF': {'ID': 'R01135', 'NumCode': '348', 'CharCode': 'HUF', 'Nominal': 100,
                     'Name': 'Венгерских форинтов', 'Value': 24.4835, 'Previous': 24.6274},
             'VND': {'ID': 'R01150', 'NumCode': '704', 'CharCode': 'VND', 'Nominal': 10000,
             ...
             'KZT': {'ID': 'R01335', 'NumCode': '398', 'CharCode': 'KZT', 'Nominal': 100,
                     'Name': 'Казахстанских тенге', 'Value': 18.4518, 'Previous': 18.5067},
             ...
             'NZD': {'ID': 'R01530', 'NumCode': '554', 'CharCode': 'NZD', 'Nominal': 1,
                     'Name': 'Новозеландский доллар', 'Value': 53.0544, 'Previous': 53.3535},
